...
public class GameManager : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (Input.GetKeyDown(KeyCode.Escape)) //어플 종료
			Application.Quit();
	}
	...
	public void End()
	{
		SoundManager.GetComponent<SoundManager>().BGM.Stop();
		if (GameOver == "RedDie")
		{
			PlayGame = false;
			Win.SetActive(true);
			...
			SoundManager.GetComponent<SoundManager>().Victory.Play();
		}
		else if (GameOver == "BlueDie")
		{
			...
			SoundManager.GetComponent<SoundManager>().Defeat.Play();
		}
	}
